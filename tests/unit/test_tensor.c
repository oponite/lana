...
static void axis_reductions(void) {
    ...
    LanaTensor t = {2, shape, strides, false, LANA_TENSOR_F64, (uint8_t *)data, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    Value args[] = {lana_value_tensor(&t), lana_value_number(0)};
    double sums[] = {5, 7, 9}, means[] = {2.5, 3.5, 4.5};
    LanaTensor expected = {1, &out_size, NULL, false, LANA_TENSOR_F64, (uint8_t *)sums, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
...
static void indexing(void) {
    ...
    LanaTensor expected_row = {1, &row, &one, false, LANA_TENSOR_F64, (uint8_t *)row_456, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    args[1] = lana_value_number(1);
    ...
    double col_25[] = {2, 5};
    LanaTensor expected_col = {1, &two, &col_stride, false, LANA_TENSOR_F64, (uint8_t *)col_25, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor expected_whole = {2, shape, strides, false, LANA_TENSOR_F64, (uint8_t *)data, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor expected_empty = {2, empty_shape, strides, false, LANA_TENSOR_F64, (uint8_t *)data, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor scalar = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)data, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor column = {1, &col_shape, &col_strides, false, LANA_TENSOR_F64, (uint8_t *)data, 1, &t, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    double doubled[] = {4, 10};
    LanaTensor expected_doubled = {1, &two, &one, false, LANA_TENSOR_F64, (uint8_t *)doubled, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    double cdata[] = {3, 4};
    LanaTensor ctensor = {1, &c_size, &c_stride, true, LANA_TENSOR_COMPLEX, (uint8_t *)cdata, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    args[0] = lana_value_tensor(&ctensor);
    args[1] = lana_value_number(0);
    LanaTensor expected_c = {0, NULL, NULL, true, LANA_TENSOR_COMPLEX, (uint8_t *)cdata, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
...
static void matmul(void) {
    ...
    LanaTensor ta = {1, &v3, &one, false, LANA_TENSOR_F64, (uint8_t *)a1, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor tb = {1, &v3, &one, false, LANA_TENSOR_F64, (uint8_t *)b1, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double dot[] = {32};
    LanaTensor expected_dot = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)dot, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tbm = {2, s23, st32, false, LANA_TENSOR_F64, (uint8_t *)bm, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    size_t two = 2;
    double vm[] = {22, 28};
    LanaTensor expected_vm = {1, &two, &one, false, LANA_TENSOR_F64, (uint8_t *)vm, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tam = {2, s23b, st23b, false, LANA_TENSOR_F64, (uint8_t *)am, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double mv[] = {14, 32};
    LanaTensor expected_mv = {1, &two, &one, false, LANA_TENSOR_F64, (uint8_t *)mv, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor ta2 = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)a2, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor tb2 = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)b2, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double mm[] = {19, 22, 43, 50};
    LanaTensor expected_mm = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)mm, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tab = {3, s222, st222, false, LANA_TENSOR_F64, (uint8_t *)ab, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    size_t s122[] = {1, 2, 2}, st122[] = {4, 2, 1};
    double bb[] = {1, 0, 0, 1}; /* identity, broadcast across the batch */
    LanaTensor tbb = {3, s122, st122, false, LANA_TENSOR_F64, (uint8_t *)bb, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double batched[] = {1, 2, 3, 4, 5, 6, 7, 8};
    LanaTensor expected_batched = {3, s222, st222, false, LANA_TENSOR_F64, (uint8_t *)batched, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tca = {2, s22, st22, true, LANA_TENSOR_COMPLEX, (uint8_t *)ca, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor tcb = {2, s22, st22, true, LANA_TENSOR_COMPLEX, (uint8_t *)cb, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double cm[] = {-1, 0, 0, 0, 0, 0, -1, 0};
    LanaTensor expected_cm = {2, s22, st22, true, LANA_TENSOR_COMPLEX, (uint8_t *)cm, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tbase24 = {2, s24, st24, false, LANA_TENSOR_F64, (uint8_t *)base24, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    size_t s23v[] = {2, 3}, st23v[] = {4, 1};
    LanaTensor view23 = {2, s23v, st23v, false, LANA_TENSOR_F64, (uint8_t *)base24, 0, &tbase24, false, LANA_TENSOR_CPU, NULL, NULL};
    double b32[] = {1, 0, 0, 1, 1, 1};
    LanaTensor tb32 = {2, s23, st32, false, LANA_TENSOR_F64, (uint8_t *)b32, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double strided[] = {4, 5, 12, 13};
    LanaTensor expected_strided = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)strided, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor view22 = {2, s22v, st22v, false, LANA_TENSOR_F64, (uint8_t *)base24, 0, &tbase24, false, LANA_TENSOR_CPU, NULL, NULL};
    double b22p[] = {1, 1, 0, 1};
    LanaTensor tb22p = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)b22p, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double packed[] = {1, 4, 5, 12};
    LanaTensor expected_packed = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)packed, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    double empty_a[] = {0};
    LanaTensor tea = {2, s20, st20, false, LANA_TENSOR_F64, (uint8_t *)empty_a, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    size_t s03[] = {0, 3}, st03[] = {3, 1};
    double empty_b[] = {0};
    LanaTensor teb = {2, s03, st03, false, LANA_TENSOR_F64, (uint8_t *)empty_b, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    size_t s23o[] = {2, 3}, st23o[] = {3, 1};
    double empty_out[] = {0, 0, 0, 0, 0, 0};
    LanaTensor expected_empty = {2, s23o, st23o, false, LANA_TENSOR_F64, (uint8_t *)empty_out, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor scalar = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)a1, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor ta3 = {2, s33, st33, false, LANA_TENSOR_F64, (uint8_t *)a3, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tabad = {3, s322, st322, false, LANA_TENSOR_F64, (uint8_t *)abad, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    size_t s222b[] = {2, 2, 2}, st222b[] = {4, 2, 1};
    double bbad[] = {1, 0, 0, 1, 1, 0, 0, 1};
    LanaTensor tbbad = {3, s222b, st222b, false, LANA_TENSOR_F64, (uint8_t *)bbad, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
...
static void gpu_matmul(void) {
    ...
    LanaTensor texpected = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)expected, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
...
static void dtype_construction(void) {
    ...
    LanaTensor expected16 = {1, &one, &stride, false, LANA_TENSOR_F16, (uint8_t *)r16, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor expected_bf = {1, &one, &stride, false, LANA_TENSOR_BF16, (uint8_t *)rbf, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
...
static void uncertainty_propagation(void) {
    ...
    LanaTensor ta = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)a_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor va = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)a_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor tb = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)b_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor vb = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)b_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double add_pred[] = {4, 6}, add_var[] = {0.625, 0.3125};
    LanaTensor e_add_pred = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)add_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_add_var = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)add_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    call_uncertain_binary(LANA_HOST_TENSOR_ADD, &ta, &va, &tb, &vb, &e_add_pred, &e_add_var);
    double sub_pred[] = {-2, -2};
    LanaTensor e_sub_pred = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)sub_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor e_mixed_var = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)mixed_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor e_mul_pred = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)mul_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_mul_var = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)mul_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor td = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)d_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor vd = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)d_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor te = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)e_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor ve = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)e_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double div_pred[] = {0.5, 0.5}, div_var[] = {0.3125, 0.3125};
    LanaTensor e_div_pred = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)div_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_div_var = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)div_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor e_dot_pred = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)dot_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_dot_var = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)dot_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor ts = {1, &n4, &one, false, LANA_TENSOR_F64, (uint8_t *)s_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor vs = {1, &n4, &one, false, LANA_TENSOR_F64, (uint8_t *)s_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    double sum_pred[] = {10}, sum_var[] = {0.9375};
    LanaTensor e_sum_pred = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)sum_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_sum_var = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)sum_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    call_uncertain_reduce(LANA_HOST_TENSOR_SUM, &ts, &vs, NULL, &e_sum_pred, &e_sum_var);
    double mean_pred[] = {2.5}, mean_var[] = {0.05859375};
    LanaTensor e_mean_pred = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)mean_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_mean_var = {0, NULL, NULL, false, LANA_TENSOR_F64, (uint8_t *)mean_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tm = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)m_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor vm2 = {2, s22, st22, false, LANA_TENSOR_F64, (uint8_t *)m_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    Value axis0 = lana_value_number(0);
    double asum_pred[] = {4, 6}, asum_var[] = {0.625, 0.3125};
    LanaTensor e_asum_pred = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)asum_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_asum_var = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)asum_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor e_amean_pred = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)amean_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor e_amean_var = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)amean_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor vinf = {1, &n2, &one, false, LANA_TENSOR_F64, (uint8_t *)inf_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    ...
    LanaTensor tc = {1, &n2, &one, true, LANA_TENSOR_COMPLEX, (uint8_t *)c_pred, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
    LanaTensor vc = {1, &n2, &one, true, LANA_TENSOR_COMPLEX, (uint8_t *)c_var, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
...
int main(void) {
    ...
    LanaTensor tensor = {1u, &size, &stride, true, LANA_TENSOR_COMPLEX, (uint8_t *)data, 0, NULL, false, LANA_TENSOR_CPU, NULL, NULL};
