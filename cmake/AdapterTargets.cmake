...
add_library(lana_adapter_http_json SHARED runtime/c/adapters/http_json_adapter.c)
...
add_executable(lana_http_service runtime/c/http_service.c)
...
add_executable(lana_http_adapter_tests tests/unit/test_http_adapter.c)
...
if(LANA_PYTEST)
    add_test(NAME lana_python_api_tests
        COMMAND ${LANA_PYTEST}
            ...
            ${CMAKE_CURRENT_SOURCE_DIR}/integrations/python/tests/test_lana.py
            -q)
